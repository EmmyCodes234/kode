...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@kode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@kode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.KODE_FAKE_VCS)
