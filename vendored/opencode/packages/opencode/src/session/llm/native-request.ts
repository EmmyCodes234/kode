import type { JsonSchema, LLMRequest, ProviderMetadata } from "@kode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@kode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @kode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
