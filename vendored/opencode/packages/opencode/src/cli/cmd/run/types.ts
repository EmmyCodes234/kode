...
import type { KodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@kode/sdk/v2"
...
type PromptModel = Parameters<KodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<KodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<KodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<KodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<KodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<KodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<KodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<KodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<KodeClient["question"]["reject"]>[0]
