...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/sicario-labs/kode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("kode-version", InstallationVersion)
