...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KODE_CALLER", () => {
    process.env["KODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KODE_CALLER", () => {
    process.env["KODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KODE_CALLER", () => {
    process.env["KODE_CALLER"] = "unknown"
