...
import { ensureProcessMetadata } from "../util/kode-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "kode.client": Flag.KODE_CLIENT,
      "kode.process_role": processMetadata.processRole,
      "kode.run_id": processMetadata.runID,
