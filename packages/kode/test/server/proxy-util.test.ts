...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips kode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-kode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-kode-directory")).toBeNull()
      expect(result.get("x-kode-workspace")).toBeNull()
