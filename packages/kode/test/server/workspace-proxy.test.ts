...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips kode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-kode-directory"]).toBeUndefined()
      expect(forwarded["x-kode-workspace"]).toBeUndefined()
