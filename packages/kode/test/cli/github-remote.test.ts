...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kode.git")).toEqual({ owner: "sst", repo: "kode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kode")).toEqual({ owner: "sst", repo: "kode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kode.git")).toEqual({ owner: "sst", repo: "kode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kode")).toEqual({ owner: "sst", repo: "kode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kode.git")).toEqual({ owner: "sst", repo: "kode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kode")).toEqual({ owner: "sst", repo: "kode" })
})
