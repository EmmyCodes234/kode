  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "kode-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "kode-glob-reference")
