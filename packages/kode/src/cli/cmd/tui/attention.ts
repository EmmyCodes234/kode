...
} from "@kode/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@kode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@kode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@kode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@kode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@kode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@kode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "Kode"
const DEFAULT_PACK_ID = "kode.default"
