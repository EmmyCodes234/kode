...
import type { AssistantMessage, FilePart, UserMessage } from "@kode/sdk/v2"
...
import { KODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useKodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.KODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
