...
export class Service extends Context.Service<Service, Interface>()("@kode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __KODE_PHOTON_WASM_PATH?: string }).__KODE_PHOTON_WASM_PATH =
