...
export class Service extends Context.Service<Service, Interface>()("@kode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via Kode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @kode/llm. It
