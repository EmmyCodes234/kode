import { Slug } from "@kode/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@kode/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@kode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".kode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@kode/Session") {}
